...
if (isset($_POST['update_account'])) {
    ...
    if (!empty($profile_pic)) {
        ...
        $query = "UPDATE iB_admin SET name=?, email=?, number=?, profile_pic=? WHERE admin_id=?";
        $stmt = $mysqli->prepare($query);
        $rc = $stmt->bind_param('ssssi', $name, $email, $number, $profile_pic, $admin_id);
    } else {
        $query = "UPDATE iB_admin SET name=?, email=?, number=? WHERE admin_id=?";
        $stmt = $mysqli->prepare($query);
        $rc = $stmt->bind_param('sssi', $name, $email, $number, $admin_id);
    }
    $stmt->execute();
                                            ...
                                            <div class="tab-pane active" id="update_Profile">
                                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" required name="number" value="<?php echo $row->number; ?>" id="inputName2">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="custom-file">
                                                                <input type="file" name="profile_pic" class="custom-file-input" id="profilePic">
