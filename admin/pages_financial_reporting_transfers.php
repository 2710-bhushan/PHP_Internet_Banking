            ...
            <div class="card">
              ...
              <div class="card-body">
                    ...
                    <div class="col-md-3 form-group mb-0">
                      <div class="row">
                        ...
                        <div class="col-6 pl-1">
                          <a href="pages_financial_reporting_transfers.php" class="btn btn-secondary btn-sm btn-block"><i class="fas fa-undo mr-1"></i> Reset</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <table id="export" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    // Get filtered transfers transactions 
