...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form method="get" class="mb-4 bg-light p-3 rounded" style="border: 1px solid var(--border-color)">
                  <div class="row align-items-end">
                    <div class="col-md-3 form-group mb-2 mb-md-0">
                      <label class="small font-weight-bold">Date From</label>
                      <input type="date" name="date_from" value="<?php echo isset($_GET['date_from']) ? htmlspecialchars($_GET['date_from']) : ''; ?>" class="form-control form-control-sm">
                    </div>
                    <div class="col-md-3 form-group mb-2 mb-md-0">
                      <label class="small font-weight-bold">Date To</label>
                      <input type="date" name="date_to" value="<?php echo isset($_GET['date_to']) ? htmlspecialchars($_GET['date_to']) : ''; ?>" class="form-control form-control-sm">
                    </div>
                    <div class="col-md-3 form-group mb-2 mb-md-0">
                      <label class="small font-weight-bold">Account Number</label>
                      <input type="text" name="account_no" value="<?php echo isset($_GET['account_no']) ? htmlspecialchars($_GET['account_no']) : ''; ?>" class="form-control form-control-sm" placeholder="Filter by Acc No.">
                    </div>
                    <div class="col-md-3 form-group mb-0">
                      <div class="row">
                        ...
                        <div class="col-6 pl-1">
                          <a href="pages_financial_reporting_withdrawals.php" class="btn btn-secondary btn-sm btn-block"><i class="fas fa-undo mr-1"></i> Reset</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <table id="export" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    // Get filtered withdrawals transactions 
                    ...
                    if (!empty($_GET['account_no'])) {
                        $ret .= " AND account_number = ?";
                        $params[] = trim($_GET['account_no']);
                        $types .= "s";
                    }
  ...
  <!-- PDFMake Libraries for DataTables PDF Export -->
