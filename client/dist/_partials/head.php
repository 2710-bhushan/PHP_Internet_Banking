...
?>
    ...
    <head>
        ...
        <!-- Modern Custom Banking UI & Theme Switcher -->
        <link rel="stylesheet" href="../dist/css/custom-banking.css?v=<?php echo time(); ?>">
        <script src="../dist/js/custom-banking.js?v=<?php echo time(); ?>"></script>
